...
<body class="p-6 md:p-12">
    ...
    <div class="max-w-6xl mx-auto">
        <header class="mb-10">
            <h1 class="text-3xl font-bold bg-gradient-to-r from-white to-gray-500 bg-clip-text text-transparent">Submit New Artwork</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div class="lg:col-span-7 space-y-8">
                <div class="card-dark">
                    <h2 class="text-xl font-semibold mb-6 flex items-center gap-2">
                        <span class="w-2 h-6 bg-yellow-500 rounded-full"></span> Artist Biography
                    </h2>
                            ...
                            <div class="group relative w-full aspect-square rounded-xl overflow-hidden border border-[#404040] cursor-pointer shadow-lg">
                                ...
                                <div class="absolute inset-0 bg-black/70 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <div class="text-center transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                                        ...
                                        <span class="block text-[11px] mt-2 font-medium text-yellow-400">Change Photo</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-dark">
                    <h2 class="text-xl font-semibold mb-6 flex items-center gap-2">
                         <span class="w-2 h-6 bg-yellow-500 rounded-full"></span> Art Identification
                    </h2>
                    <div class="space-y-5">
                        <div>
            ...
            <div class="lg:col-span-5 space-y-8">
                <div class="card-dark">
                    <h2 class="text-xl font-semibold mb-6 flex items-center gap-2">
                        <span class="w-2 h-6 bg-yellow-500 rounded-full"></span> Product Detail
                    </h2>
                    <div class="space-y-4">
                        <div>
                ...
                <div class="card-dark">
                    <h2 class="text-xl font-semibold mb-6 flex items-center gap-2">
                        <span class="w-2 h-6 bg-yellow-500 rounded-full"></span> Art Pricing
                    </h2>
                    <div class="grid grid-cols-2 gap-4">
                        <div class="col-span-2 sm:col-span-1">
                            <label class="block text-[10px] label-text mb-2">Base Price</label>
                            <div class="flex">
                                <span class="bg-[#333] px-4 py-3 rounded-l-lg border-y border-l border-[#404040] text-sm text-yellow-500 font-bold">$</span>
                ...
                <div class="card-dark">
                    <h2 class="text-xl font-semibold mb-6 flex items-center gap-2">
                        <span class="w-2 h-6 bg-yellow-500 rounded-full"></span> Media Assets
                    </h2>
                    <div class="flex flex-wrap gap-3">
                        <div class="w-20 h-20 border-2 border-dashed border-neutral-700 rounded-xl flex items-center justify-center cursor-pointer hover:border-yellow-500 transition-colors group">
                            <span class="text-neutral-500 group-hover:text-yellow-500 text-xl">＋</span>
                        </div>
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-4 pt-4">
                    ...
                    <button onclick="handleUpload()" class="px-10 py-3 bg-yellow-500 hover:bg-yellow-400 text-black rounded-xl font-bold shadow-lg shadow-yellow-500/10 transition-all">
                        Publish Artwork
                    </button>
                </div>
            </div>
